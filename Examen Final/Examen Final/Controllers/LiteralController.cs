namespace Examen_Final.Controllers
{
    ...
    public class LiteralController : Controller
    {
        ...
        private string Billon(char x)
        {
            ...
            { return "Dos Billones "; }
            if (x == '3')
            { return "Tres Billones "; }
            if (x == '4')
            { return "Cuatro Billones "; }
            if (x == '5')
            { return "Cinco Billones "; }
            if (x == '6')
            { return "Seis Billones "; }
            if (x == '7')
            { return "Siete Billones "; }
            if (x == '8')
            { return "Ocho Billones "; }

            return "Nueve Billones ";
        ...
        public string NumeroGet(string num1)
        {
            ...
            if (num1.Length == 7)
            {
                ...
                {
                    respuesta += " punto ";
                    respuesta += Decena(num1[9]);
                    if (num1[10] != '0')
                    { respuesta += " y "; }
                    respuesta += Unidad(num1[10]);
                }
